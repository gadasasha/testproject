/*
Скрипт развертывания для TestDB001
...
GO
:setvar DatabaseName "TestDB001"
:setvar DefaultFilePrefix "TestDB001"
...
GO
PRINT N'Выполняется создание ограничение без названия для [dbo].[tb_services_balances]...';


GO
ALTER TABLE [dbo].[tb_services_balances]
    ADD DEFAULT getutcdate() FOR [date_post];


GO
PRINT N'Выполняется создание [dbo].[FK_tb_services_balances_sums_ToTb_services_balances]...';


GO
ALTER TABLE [dbo].[tb_services_balances_sums]
    ADD CONSTRAINT [FK_tb_services_balances_sums_ToTb_services_balances] FOREIGN KEY ([service_id]) REFERENCES [dbo].[tb_services_balances] ([service_id]);
